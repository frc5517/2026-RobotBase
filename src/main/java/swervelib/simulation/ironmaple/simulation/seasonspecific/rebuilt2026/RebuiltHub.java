...
public class RebuiltHub extends Goal {
    ...
    protected static final Pose3d blueShootPose =
        new Pose3d(
                blueHubPose.plus(new Translation3d(0.5969, 0.149225, -0.58)),
                new Rotation3d(Degrees.of(0), Degrees.of(-18), Degrees.of(0)));

    public static final double GoalRadius = 0.5969;
    static final Random rng = new Random();

    protected static final Pose3d redShootPose =
            new Pose3d(
                    redHubPose.minus(new Translation3d(0.5969, 0.149225, 0.58)),
                    new Rotation3d(Degrees.of(0), Degrees.of(-18), Degrees.of(180)));
    ...
    public void addPoints() {
        ...
        Pose3d shootPose = isBlue ? blueShootPose : redShootPose;
