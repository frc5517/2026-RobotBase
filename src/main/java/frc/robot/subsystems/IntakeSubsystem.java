...
public class IntakeSubsystem extends SubsystemBase {
    ...
    public static class HardwareConstants {
        ...
        public static final Current CURRENT_LIMIT = Amp.of(60); // Limits the current, this is a simple intake. We want the limit low so we don't break things in the case of a jam.
        /// Intake Constants
