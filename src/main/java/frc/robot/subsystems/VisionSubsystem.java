...
public class VisionSubsystem
{
    ...
    enum Cameras {
        /// Center Camera
        CENTER_CAM("center",
                new Rotation3d(0, Units.degreesToRadians(-18), Units.degreesToRadians(45)),
                new Translation3d(Units.inchesToMeters(-4.628),
                        Units.inchesToMeters(-10.687),
                        Units.inchesToMeters(16.129)),
                VecBuilder.fill(4, 4, 8), VecBuilder.fill(0.5, 0.5, 1)),
        A_CAM("a_center",
                new Rotation3d(0, Units.degreesToRadians(-18), Units.degreesToRadians(90)),
                new Translation3d(Units.inchesToMeters(-4.628),
                        Units.inchesToMeters(-10.687),
                        Units.inchesToMeters(16.129)),
                VecBuilder.fill(4, 4, 8), VecBuilder.fill(0.5, 0.5, 1)),
        B_CAM("b_center",
                new Rotation3d(0, Units.degreesToRadians(-18), Units.degreesToRadians(180)),
                new Translation3d(Units.inchesToMeters(-4.628),
                        Units.inchesToMeters(-10.687),
                        Units.inchesToMeters(16.129)),
                VecBuilder.fill(4, 4, 8), VecBuilder.fill(0.5, 0.5, 1));
                ...
                Matrix<N3, N1> singleTagStdDevs, Matrix<N3, N1> multiTagStdDevsMatrix)
        {
            ...
            if (Robot.isSimulation())
            {
                ...
                cameraProp.setCalibError(0.15, 0.08);
