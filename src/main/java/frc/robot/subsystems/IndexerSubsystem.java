...
public class IndexerSubsystem extends SubsystemBase {
    ...
    public static class HardwareConstants {
        ...
        public static final Current CURRENT_LIMIT = Amp.of(35); // Limits the current, this is a simple indexer. We want the limit low so we don't break things in the case of a jam.
        /// Indexer Constants
